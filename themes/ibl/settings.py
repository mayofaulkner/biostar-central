...
CUSTOM_THEME = os.path.abspath(os.path.join(BASE_DIR, 'themes', 'ibl'))

ACCOUNT_EMAIL_SUBJECT_PREFIX = "[ibl] "
HTTP_PROTOCOL = "http"
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries': {
                'ibl_tags': 'themes.ibl.templatetags.ibl_tags',
            },
        },
    },
]
...
SITE_NAME = "International Brain Laboratory Support Forum"
